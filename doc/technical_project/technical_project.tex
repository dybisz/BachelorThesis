...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\textwidth]{images/clustering_class.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\textwidth]{images/classification_class.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{images/dfa.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{images/math_class.jpg}
