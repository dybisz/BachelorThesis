...
The more detailed implementation of the entire project is presented here.
...
The Classifier Constructor encapsulates libraries to create a classifier. The simplified process is presented in figure~\ref{fig:classification_states}. The classes are loaded and transformed to languages. Languages are assigned states based on application settings and then the classifier constructor is started for the chosen optimization algorithm. User can provide values for all the settings in the application.
