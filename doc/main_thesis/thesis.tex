...
The four distinct fitness functions were used in the multi class problem. Similarly the two class problem was experimented using indistinct fitness functions.
