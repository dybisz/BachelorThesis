...
\begin{figure}[H]
    \caption{Similarity of Transformed Languages}
    \label{fig:lang_sim}
    ...
    \nextgroupplot[title=Similarity of Languages. Distinct Native vs Native]
...
\begin{figure}[H]
    ...
    \nextgroupplot[title=Similarity of Languages. Indistinct Native vs Foreign]
