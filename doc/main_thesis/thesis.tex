...
Subsequent section is a direct copy of corresponding chapter from \cite{rejector_geo}. Due to the fact that we co-authored the paper, such an action seemed permissible. What is more in both - following work and \cite{rejector_geo}, measures are used for the same purposes - to assess constructed classifiers. %moze przeformulowac? 
