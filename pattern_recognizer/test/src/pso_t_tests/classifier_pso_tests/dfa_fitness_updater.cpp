...
#include <classifier_problem/dfa_particle_decoder.h>
#include <classifier_problem/dfa_fitness_updater.h>
#include <languages/word.h>
...
TEST(DFAFitnessUpdater,
    ...
    Particle_T* particle = new Particle_T(createParticle_s4_r2());

    unsigned int stateCount = 4;
    unsigned int symbolCount = 2;
    double encodingDelta = 0.5;

    ParticleDecoder_T* decoder =
